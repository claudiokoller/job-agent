...
1. Relevanz zum Profil → wichtigster Faktor
2. Sprache: bevorzugte Sprache der Stelle → +1 Punkt; unpassende Sprache → -1 Punkt
3. Seriosität: bekannte, regulierte Unternehmen bevorzugt
...
- "Tech & Engineering": Software, Daten, Systeme, Infrastruktur mit Fintech-Bezug
...
- kategorie: eine der drei Kategorien oben
...
def filter_and_score(jobs: list[dict]) -> list[dict]:
    ...
    return filtered[:8]  # Max 8 pro Sendung
